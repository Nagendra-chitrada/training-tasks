...
// let clientrecipie=new XMLHttpRequest();
// console.log(clientRequest);

// clientRequest.open("GET",'https://forkify-api.herokuapp.com/api/search?q=avocado');
// clientRequest.send();
// console.log(clientRequest);
...
// clientrecipie.open("GET",'https://forkify-api.herokuapp.com/api/get?rId=47746');
// clientrecipie.send();
// console.log(clientrecipie);
// clientrecipie.addEventListener("load",function(){
...
// // console.log(itemsForkify.length);    
// }else{
